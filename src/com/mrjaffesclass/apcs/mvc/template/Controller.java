...
public class Controller implements MessageHandler {
  ...
  public Controller() {
    ...
    View view = new View(mvcMessaging);    // creates the view
    view.init();
    view.setVisible(true);

    // Create the model
    Model model = new Model(mvcMessaging);  // creates the model
    model.init();
  }
   ...
   */
  public void init() {
    // This is area to subscribe to any messages the controller
  ...
  public static void main(String[] args) {
    Controller app = new Controller();  // creates the controller
    app.init();                         // initializes controller
  }
